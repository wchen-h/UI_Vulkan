...
// RGB(BT.2020 linear, [0,1]) -> LMS (standard BT.2100-2, integer / 4096)
const mat3 RGB2LMS = mat3(
     0.41210938,  0.16674805,  0.02416992,
     0.52392578,  0.72045898,  0.07543945,
     0.06396484,  0.11279297,  0.90039062);

// LMS(PQ) -> ICtCp (standard BT.2100-2 M2, PQ variant, 1/4096 scaled)
const mat3 LMS2ICTCP = mat3(
     0.50000000,  1.61376953,  4.37817383,
     0.50000000, -3.32348633, -4.24560547,
     0.00000000,  1.70971680, -0.13256836);

// ICtCp -> LMS(PQ) (inverse of standard BT.2100-2 M2)
const mat3 ICTCP2LMS = mat3(
     1.00000000,  1.00000000,  1.00000000,
     0.00860904, -0.00860904,  0.56003134,
     0.11102963, -0.11102963, -0.32062717);

// LMS -> RGB(BT.2020 linear, [0,1]) (inverse of RGB2LMS)
